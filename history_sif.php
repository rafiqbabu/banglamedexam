...
<?php 
    ...
    $qid="SELECT * FROM oe_doc_master WHERE reg_no = '$_GET[reg_no]'";
	$qid2 = mysqli_query($link, $qid);
	while($did = mysqli_fetch_array($qid2)){
	    $id=$did[id];
	}
...
<table border="0" align="center" cellpadding="2" cellspacing="0" width="1000">
    <tr align="center">
        ...
        <td><font face="Verdana" size="6">Online Exam</font><br><font face="Verdana" size="4">Exam History</font></td>
        <td width="200"></td>
    </tr>
    <tr>
        <td colspan="3"><hr></td>
