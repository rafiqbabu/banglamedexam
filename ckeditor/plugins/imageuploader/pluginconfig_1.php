<?php
$UPLOAD_FOLDER_PATH = '/var/www/html/oe-gen/uploads/media/';
$UPLOAD_BROWSE_PATH = 'oe-gen/uploads/media/';



//$UPLOAD_FOLDER_PATH = '/var/www/html/bigm-bd/oe-gen/uploads/media';
//$UPLOAD_BROWSE_PATH = 'bigm-bd.com/oe-gen/uploads/media/';
//include("$_SERVER[DOCUMENT_ROOT]oe-gen/application/config/database.php");
...
$useruploadpath = $UPLOAD_FOLDER_PATH; //'E:\wamp-current/www/oe-gen/uploads/media/';//$usersiteroot."$useruploadfolder/";// 'E:\wamp-current/www/oe-gen/uploads/media/';
