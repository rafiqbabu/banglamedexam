<?php
$UPLOAD_FOLDER_PATH = "/home/genesisedu/public_html/banglamedexam.com/uploads/media/";
$UPLOAD_BROWSE_PATH = "uploads/media/";


//$UPLOAD_FOLDER_PATH = '/var/www/html/bigm-bd/aerp-admin/uploads/media'; 
//$UPLOAD_BROWSE_PATH = 'bigm-bd.com/aerp-admin/uploads/media/';

//include("$_SERVER[DOCUMENT_ROOT]/banglamedexam/application/config/database.php");
...
$useruploadpath = $UPLOAD_FOLDER_PATH; //'E:\wamp-current/www/aerp-admin/uploads/media/';//$usersiteroot."$useruploadfolder/";// 'E:\wamp-current/www/aerp-admin/uploads/media/';
$foldershistory[] = $useruploadfolder;
    ...
    $useruploadfolder = "./uploads/media";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "./uploads/media";
