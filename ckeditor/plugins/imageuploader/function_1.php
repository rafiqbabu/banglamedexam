...
function loadImages() {
    ...
    if(file_exists($useruploadpath)){
        ...
        for($i=count($files)-1; $i >= 0; $i--):
            ...
            //echo $image_url = $site.$useruploadfolder."/".$image_basename;
			
			//$image_url =  $site.'aerp-admin/uploads/media/'.$image_basename;
			$image_url =  $site.$UPLOAD_BROWSE_PATH.$image_basename;
