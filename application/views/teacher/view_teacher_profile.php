                    ...
                    <div class="panel-body profile-information">
                        ...
                        <div class="col-md-6">
                            <div class="profile-desk">
                                <h1><?= $res->tec_name; ?></h1>
                                <strong class="text-info">Teacher of <?php echo implode(', ', $res->subjects); ?></strong><br>
                                <p class="text-muted">Specialized: <?php echo implode(', ', $res->topics); ?></p><br>
                                <p><?php //echo strip_tags($res->edu_qualifi); ?></p>
                        ...
                        <div class="col-md-3">
                            ...
                            <div>
                                <a href="<?php echo site_url('teacher/print_profile/'.$res->id)?>" class="btn btn-warning" target="_blank"><i class="fa fa-print"></i> Print</a>
                                        ...
                                        <div class="col-md-12">
                                            <div class="prf-box">
                                                <div class="wk-progress pf-status">
                                                    ...
                                                    <div class="col-md-2">
                                                        <strong><?php echo $res->tec_name; ?></strong></div>
                                                    <div class="col-md-2">Subject</div>
                                                    <div class="col-md-6">
                                                        <strong>
                                                            <?php echo implode(', ', $res->subjects) ?>
                                                        </strong>
                                                    </div>
                                                </div>
                                                <div class="wk-progress pf-status">
                                                    ...
                                                    <div class="col-md-2">
                                                        <strong><?php echo implode(', ', $res->topics); ?></strong></div>
                                                    <div class="col-md-2">Courses</div>
                                                    <div class="col-md-2">
                                                        <strong>
                                                            <?php  echo implode(', ', $res->courses); ?>
                                                        </strong>
                                                    </div>
                                                    <div class="col-md-2">Type</div>
                                                    <div class="col-md-2">
                                                        <strong>
                                                            <?php echo implode(', ', $res->types);?>
                                                        </strong>
                                                    </div>
                                                </div>
<!--                                                <div class="wk-progress pf-status">-->
<!--                                                    <div class="col-md-2">Faculties</div>-->
<!--                                                    <div class="col-md-4">-->
<!--                                                        <strong>--><?php //echo implode(', ', $res->faculties); ?><!--</strong></div>-->
<!--                                                    -->
<!--                                                </div>-->
                                                <div class="wk-progress pf-status">
