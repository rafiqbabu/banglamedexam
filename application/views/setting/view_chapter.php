                ...
                <section class="panel panel-info">
                    ...
                    <div class="panel-body">
                        <div class="form">
                            ...
                            <?php
                            if ($form_action == "add") {
                                $action_url = base_url() . 'setting/save_chapter';
                                $btn_val = 'SAVE';
                            } elseif ($form_action == "edit") {
                                $action_url = base_url() . 'setting/update_chapter';
                                $btn_val = 'UPDATE';
                            }
                            ?>
                            <form class="cmxform form-horizontal " id="commentForm" role="form" method="post" action="<?php echo $action_url; ?>">
                                ...
                                <div class="form-group ">
                                    <label for="Name" class="control-label col-lg-3">Chapter Name</label>
                                    <div class="col-lg-6">
                                    <input class=" form-control" id="chapter_name" name="chapter_name" type="text" value="<?php echo isset($res->chapter_name)? $res->chapter_name:''; ?>"/>
                                    </div>
                                </div>
                                ...
                                if (!empty($record)) {
                                    ...
                                    foreach ($record as $key => $value) {
                                        ...
                                        <tr>                                               
                                            ...
                                            <td>
                                                <a href="<?php echo base_url() . 'setting/edit_chapter/' . $value->id; ?>" class="btn btn-warning btn-xs" title="Edit" data-toggle="tooltip" data-placement="top"
