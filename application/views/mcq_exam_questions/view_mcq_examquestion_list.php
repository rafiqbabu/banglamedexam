    ...
    <section class="wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                <section class="panel panel-info">
                    <header class="panel-heading">
                        MCQ Question Bank List (<?= $total_rows; ?>)
                        <span class="tools pull-right">
                            <a class="fa fa-chevron-down" href="javascript:"></a>
                            <a class="fa fa-cog" href="javascript:"></a>
                            <a class="fa fa-times" href="javascript:"></a>
                         </span>
                        <a class="fa fa-print btn btn-sm pull-right btn-warning" href="<?= site_url( 'exam_question/print_questions/2' ); ?>" target="_blank"> Print</a>
                    </header>
                    <div class="panel-body">
                        <?php
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            if ( !empty( $rec ) ) {
                                ...
                                foreach ( $rec as $key => $value ) {
                                    ...
                                    <tr>
                                        <td><?= $key; ?></td>
                                        <td><?php echo "(".closetags( $value->id ).") ".closetags( $value->question_name ); ?></td>
                                        ...
                                        <td class="text">
                                            ...
                                            <a href="<?php echo base_url() . 'exam_question/edit_mcq_question/' . $value->id; ?>"
