												...
												foreach ( $arr_topics as $key_topics => $value_topics ) {
													...
													<p>
														<label class="control-label">
															<input type="checkbox" name="topics_<?php echo $value->id; ?>[]"
																   value="<?php echo $value_topics->id; ?>" <?= $checked; ?>/> <?php echo $value_topics->name; ?>
														</label>
													</p>
													<?php
												}
					...
					<div class="panel panel-info">
						...
						<div class="panel-body">
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
									<div class="border-1">
                                        <textarea name="discussion" placeholder="Discussion" class="form-control"><?= ( isset( $res->discussion ) ? $res->discussion : '' ); ?></textarea>
									</div>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-lg-10">
									<div class="border-1">
                                        <textarea name="reference" placeholder="Reference" class="form-control"><?= ( isset( $res->reference ) ? $res->reference : '' ); ?></textarea>
									</div>
								</div>
							</div>
							<div class="form-group">
