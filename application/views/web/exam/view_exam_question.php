                    ...
                    <div class="widget">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3 pull-right">
								...
								<?php $second_passed =  time() - $this->session->userdata( 'last_entry_time');
										$min_passed = round($second_passed/60);
 ?>

                                    Remaining: <span class="timer"><?= $exam->duration; ?>:00</span>
                                    <?= form_hidden('timer', ($this->session->userdata( 'timer')) ? round($this->session->userdata( 'timer'))-$min_passed: $exam->duration); ?>
                                </h5>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                ...
                                <button type="submit" class="btn btn-mg bg-yellow" onclick="next_question(this, event)" name="skip"><b>Skip</b> <i class="fa fa-clock-o"></i></button>
                                
                                <button type="submit" class="btn btn-mg bg-green pull-right" onclick="next_question(this, event)" name="next">Next <i class="fa fa-angle-double-right"></i></button>
								
								  

                            </div>
								প্রশ্নটি পুনরায় পেতে 
                            <div class="clearfix"></div>
                        </div>
                        <?= form_close(); ?>
                    </div>
