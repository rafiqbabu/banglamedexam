			...
			<div class="row">
				...
				<div class="col-md-9">
					<div class="widget profile-widget">
						...
						<span class=""style="font-weight:700;font-size:19px;"><?php echo "Doc Name : ";  ?></span><span style="font-weight:700;font-size:19px;color:blue;"><?php echo $doc->name;  ?></span><br><br>
						<span class="text-success"style="font-size:19px;"><?php echo "Online Exam Results:";  ?></span><br><br>
							...
							<table class="table table-bordered table-sm padding-4">
								...
								<?php foreach ( $exams as $k => $exam ):
									...
									<tr>
										...
										<!--<td class="text-center"><?php // $exam->subject_pos; ?></td>-->
										<td class="text-center">
											<?php 
											  	/*
										...
										<!--td class="text-center"><?php // get_total_examine( $exam->exam_id ); ?></td-->
									</tr>
								<?php endforeach; ?>
								</tbody>
							</table>
