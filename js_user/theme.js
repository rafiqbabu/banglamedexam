/*
Name: 			theme.js
Written by: 	Glorythemes - (https://www.glorythemes.in)
Version: 		1.1.0
*/
...
const GMAP_API_KEY = "AIzaSyAyDob5UvR8FYbzhloyPBdUoFZEnZG5IkA";
function GmapInit() {
...
function MapLoadScript() {
	...
	script.src = 'https://maps.googleapis.com/maps/api/js?v=3.exp&sensor=false&' + 'callback=GmapInit&key='+GMAP_API_KEY;
